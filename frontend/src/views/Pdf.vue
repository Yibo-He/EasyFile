  ...
  <el-container>
    ...
    <el-main>
      ...
      <el-upload
        ...
        <div class="el-upload__text">将文件拖到此处，或<em style="color: #eb3f3f">点击上传</em></div>
        <div class="el-upload__tip" slot="tip">注意: 只能上传pdf文件</div>
      </el-upload>
      </el-col>
      ...
      <el-col :span="12" >
        ...
        <br /><br />
        <el-select v-model="functionality" placeholder="请选择PDF处理功能" >
            <el-option
        ...
        <el-input v-model="pages" placeholder="请输入处理的页码，例如1-5、8、11-13" style="width: 400px"></el-input>
        <br /><br />

        <el-button type="primary" style="background: #eb3f3f; border-color: #eb3f3f" @click="start_pdf">开始处理</el-button>
        <div>&emsp;</div>
        <el-button type="primary" style="background: #eb3f3f; border-color: #eb3f3f" icon="el-icon-download" round size="medium" @click="download">下载处理后文件</el-button>
      </el-col>
